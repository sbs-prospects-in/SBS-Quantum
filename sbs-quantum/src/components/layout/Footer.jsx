...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-brand-muted/20 pt-24 pb-12 mt-20 relative overflow-hidden">
      ...
      {!hideCTA && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-32 text-center">
          ...
          <p className="text-xl md:text-2xl text-brand-text/70 mb-12 max-w-2xl mx-auto">
            Let's engineer your next digital transformation with unparalleled precision and design.
          </p>
          <Link 
            to="/contact" 
            onClick={() => window.scrollTo(0, 0)}
            className="inline-block px-12 py-5 rounded-full text-lg font-bold bg-brand-text text-white shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all active:scale-[0.97] ease-[var(--ease-out)] duration-300"
          >
            Start Your Project
          </Link>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 ${!hideCTA ? 'pt-16 border-t border-brand-muted/20' : ''}`}>
          <div className="md:col-span-2">
            ...
            <p className="text-brand-text/70 max-w-sm mb-8 text-sm leading-relaxed">
          ...
          <div>
            <h3 className="font-display font-semibold text-brand-text mb-6 tracking-tight text-lg">Navigation</h3>
          ...
          <div>
            <h3 className="font-display font-semibold text-brand-text mb-6 tracking-tight text-lg">Contact</h3>
        ...
        <div className="border-t border-brand-muted/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-brand-text/60">
